...
# should be allowed
ifelse(SQUID_LOCALNET, {{}}, {{}}, acl localnet src SQUID_LOCALNET)
...
ifelse(SQUID_CACHE_PEER, {{}}, {{}}, cache_peer {{SQUID_CACHE_PEER}})
ifelse(SQUID_NEVER_DIRECT, {{}}, {{}}, never_direct {{SQUID_NEVER_DIRECT}})
